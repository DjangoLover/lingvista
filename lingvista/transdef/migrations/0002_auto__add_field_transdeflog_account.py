...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransDefLog.account'
        db.add_column(u'transdef_transdeflog', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['account.Account']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransDefLog.account'
        db.delete_column(u'transdef_transdeflog', 'account_id')
